...
var AuthenticationContext = (function () {
    ...
    AuthenticationContext.prototype.validateToken = function (jwtToken) {
        if (this._isEmpty(jwtToken)) {
            return null;
        };

        var jwtToken = requestInfo.parameters[this.CONSTANTS.ID_TOKEN];
        console.log("token verification");
        console.log(jwtToken);
        var kid1 = "MnC_VZcATfM5pOYiJHMba9goEKY";
        var n1Base64 = "vIqz-4-ER_vNWLON9yv8hIYV737JQ6rCl6XfzOC628seYUPf0TaGk91CFxefhzh23V9Tkq-RtwN1Vs_z57hO82kkzL-cQHZX3bMJD-GEGOKXCEXURN7VMyZWMAuzQoW9vFb1k3cR1RW_EW_P-C8bb2dCGXhBYqPfHyimvz2WarXhntPSbM5XyS5v5yCw5T_Vuwqqsio3V8wooWGMpp61y12NhN8bNVDQAkDPNu2DT9DXB1g0CeFINp_KAS_qQ2Kq6TSvRHJqxRR68RezYtje9KAqwqx4jxlmVAQy0T3-T-IAbsk1wRtWDndhO6s1Os-dck5TzyZ_dNOhfXgelixLUQ";
        var n1Hex = "";
        var e1Base64 = "AQAB";
        var e1Hex = "010001";

        var kid2 = "YbRAQRYcE_motWVJKHrwLBbd_9s";
        var n2Base64 = "vbcFrj193Gm6zeo5e2_y54Jx49sIgScv-2JO-n6NxNqQaKVnMkHcz-S1j2FfpFngotwGMzZIKVCY1SK8SKZMFfRTU3wvToZITwf3W1Qq6n-h-abqpyJTaqIcfhA0d6kEAM5NsQAKhfvw7fre1QicmU9LWVWUYAayLmiRX6o3tktJq6H58pUzTtx_D0Dprnx6z5sW-uiMipLXbrgYmOez7htokJVgDg8w-yDFCxZNo7KVueUkLkxhNjYGkGfnt18s7ZW036WoTmdaQmW4CChf_o4TLE5VyGpYWm7I_-nV95BBvwlzokVVKzveKf3l5UU3c6PkGy-BB3E_ChqFm6sPWw";
        var n2Hex = "";
        var e2Base64 = "AQAB";
        var e2Hex = "010001";

        var rsaKey = new RSAKey();
        rsaKey.setPublic(n1Hex, e1Hex);
        console.log(rsaKey.n);
        console.log(rsaKey.e);

        var isValid = KJUR.jws.JWS.verifyJWT(jwtToken, rsaKey, { alg: ['RS256'], iss: ['https://sts.windows.net/afbece03-aeaa-4f3f-85e7-ce08dd20ce50/',  });
        console.log("isValid: " + isValid + " for kid: " + kid1);
        if (!isValid) {
            rsaKey = new RSAKey();
            rsaKey.setPublic(n2Hex, e2Hex);
            console.log(rsaKey.n);
            console.log(rsaKey.e);
            isValid = KJUR.jws.JWS.verifyJWT(jwtToken, rsaKey, { alg: ['RS256'] });
        }
        console.log("isValid: " + isValid + " for kid: " + kid2);
        var headerObj = KJUR.jws.JWS.readSafeJSONString(b64utoutf8(jwtToken.split(".")[0]));
        var payloadObj = KJUR.jws.JWS.readSafeJSONString(b64utoutf8(jwtToken.split(".")[1]));
