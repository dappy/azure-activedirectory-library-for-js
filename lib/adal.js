...
var AuthenticationContext = (function () {
    ...
    AuthenticationContext.prototype.openPopup = function (urlNavigate, title, w, h) {
        //Added to center in case of dual Monitor
        ...
        var popupWindow = window.open(urlNavigate, title, 'width=' + w + ', height=' + h + ', top=' + top + ', left=' + left);

        //Puts focus on the popUpWindow
    ...
    AuthenticationContext.prototype.loginPopup = function (urlNavigate) {
        var popupWindow = this.openPopup(urlNavigate, "login", 483, 600);
